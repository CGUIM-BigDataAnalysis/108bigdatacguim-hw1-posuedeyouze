...
```
薪資成長最高的是服務業或是產業中與客戶接觸較多的服務性質的職位。
### 提高超過5%的的職業有哪些? 
```{r over5}
#篩選與排序
...
## 我有興趣的職業別薪資狀況分析
我想觀察各類型行業對念研究所帶來的薪資差距的情況，所以選擇代表創作類型的"藝術_娛樂及休閒服務業"、代表第二類型產業的"製造業"、代表深度專業類型的"專業_科學及技術服務業"、代表商業類型的"金融及保險業"和與醫療保健相關的"醫療保健業" 做資料分析
### 有興趣的職業別篩選，呈現薪資
```{r like}
#取出欄位
...
knitr::kable(s107yinterest)
```
薪資差距比想像中要少，但因為資料是剛畢業的起薪，念研究所的原因可能還有之後的升遷問題
### 這些職業別研究所薪資與大學薪資差多少呢？
```{r likeGrad}
